		...
		{#if selectedTab === 1}
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-10">
				...
				<div class="lg:col-span-2">
					...
					</a> method retrieves detailed place information about a chosen place. This information is then used to populate an optional object <code class="bg-gray-100 px-2 rounded-md">formattedAddressObj</code> component property. Response mapped to an
						optional <code class="bg-gray-100 px-2 rounded-md">formattedAddressObj</code>  based on address component types. By using <code class="bg-gray-100 px-2 rounded-md">formattedAddressObj</code>. This object parses the address components from the Places API response, making it easier to work with individual details like street number, town, and postcode. By using <code class="bg-gray-100 px-2 rounded-md">formattedAddressObj</code>, you can directly access specific address components without needing to manipulate the raw response from the Places API. This simplifies address handling in your application.
					</p>
					<ul
					role="list"
					class="divide-y divide-gray-100 overflow-hidden bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl font-mono"
				>
					<li class="relative block lg:flex justify-between gap-x-6 px-4 py-4 hover:bg-gray-50 sm:px-6">
						...
						<div class="flex items-center justify-between gap-x-4">
							<p class="text-sm leading-6 text-gray-900"><span class="inline-flex items-center rounded-md bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700">longText</span> property of</p>
						</div>
					...
					<li class="relative block lg:flex justify-between gap-x-6 px-4 py-4 hover:bg-gray-50 sm:px-6">
						...
						<div class="flex items-center justify-between gap-x-4">
							<p class="text-sm leading-6 text-gray-900"><span class="inline-flex items-center rounded-md bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700">shortText</span> property of</p>
						</div>							
						<div class="flex shrink-0 items-center gap-x-4">
							<div class="flex flex-col items-end">
	...
	<footer class="bg-white">
		<div class="mx-auto max-w-7xl py-12 md:flex md:items-center md:justify-between ">
		  <div class="flex justify-center space-x-6 md:order-2">
			...
			<a href="https://github.com/alexpechkarev/places-autocomplete-svelte" class="text-gray-400 hover:text-gray-500">
		  ...
		  <div class="mt-8 md:order-1 md:mt-0">
			<p class="text-center text-xs leading-5 text-gray-500">{new Date().getFullYear()} Places Autocomplete Svelte.</p>
		  </div>
		</div>
	  </footer>
